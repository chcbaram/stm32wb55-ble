...
{
  {GPIOC, GPIO_PIN_6 , GPIO_PIN_RESET, GPIO_PIN_SET},   // 0. LED
  {GPIOC, GPIO_PIN_13, GPIO_PIN_RESET, GPIO_PIN_SET},   // 1. LED2
  {GPIOA, GPIO_PIN_4 , GPIO_PIN_RESET, GPIO_PIN_SET},   // 2. BLE
};
